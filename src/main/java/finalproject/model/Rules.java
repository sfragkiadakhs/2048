...
public class Rules {
    ...
    /** Modifies the given board to have the given dimensions and then restarts a game on that board, returns the tiles that were added to it. Note this does not reset the highScore value of the board as the startGame method does.
     * @param board The board that the Rules are being used to modify.
     * @param width The width of the board to be made.
     * @param height The height of the board to be made.
     * @return A list of all tile on the board.  */
    ...
    private static Point getVector(Direction d) {// return the vector for the direction of the move
        Point vector;
        switch (d) {
        case UP:
