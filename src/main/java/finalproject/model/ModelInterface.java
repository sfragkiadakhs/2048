...
public interface ModelInterface{
    ...
    */
    ...
    /**
     * @param name The name of the player ,from the view
    * Creates the database connection
    * then using retrieve player to check if he is an existing player or not
    * also sets the highscore of the board for the player
    */
