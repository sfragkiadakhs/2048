...
public class Board {
    ...
    /**
     * Returns the players name associated with this board.
     * @return the players name associated with this board.
     */
    ...
    /**
     * Sets the players name associated with this board.
     * @param name the players name associated with this board.
     */
    ...
    public List<ATileMove> getAllTiles(){
        ...
        for(int x=0;x<width;x++)
            for(int y=0;y<height;y++){
                if(grid[x][y]==0) continue; // an einai 0 mh to balleis sth list, de xreiazete,phgaine sthn epomenh epanalipsi
